...
ALTER TABLE JORNADA ADD CONSTRAINT NN_MUNICIPIO_JOR CHECK(municipio_jor is not null);
ALTER TABLE JORNADA ADD CONSTRAINT NN_DIRECCION_JOR CHECK(direccion_jor is not null);
